...
export function ContactForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!isEdit && dupMatch?.exact) {
      toast.error(t('contacts.duplicatePhone'));
      return;
    }
    ...
    try {
      ...
      if (!accountId) throw new Error(t('contacts.notLinkedToAccount'));
      ...
      <DialogContent className="bg-popover border-border text-popover-foreground sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground">
            {isEdit
              ? t('contacts.form.editDesc')
              : t('contacts.form.addDesc')}
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  {onViewExisting && (
                    ...
                    >
                      {t('contacts.form.viewExisting').replace('{name}', dupMatch.contact.name || dupMatch.contact.phone)}
                    </button>
                  )}
                </div>
              </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={t('contacts.form.companyPh')}
              className="bg-muted border-border text-foreground placeholder:text-muted-foreground"
            />
          </div>
