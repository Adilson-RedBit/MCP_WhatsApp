...
export function ContactDetailView({
  ...
  async function addNote() {
    ...
    if (error) {
      toast.error(t('contacts.detail.addNoteFailed'));
    } else {
      setNewNote('');
      fetchNotes();
  ...
  async function deleteNote(noteId: string) {
    ...
    if (error) {
      toast.error(t('contacts.detail.deleteNoteFailed'));
    } else {
                    ...
                    {customFields.map((field) => (
                      <div key={field.id} className="space-y-1.5">
                        ...
                        <Input
                          ...
                          placeholder={t('contacts.detail.customFieldPh').replace('{field}', field.field_name)}
                      ...
                      >
                        ...
                        <div className="mt-1.5 flex items-center justify-between text-xs text-muted-foreground">
                          ...
                          {deal.status && deal.status !== 'open' && (
                            ...
                            >
                              {deal.status === 'won'
                                ? t('contacts.detail.dealStatusWon')
                                : t('contacts.detail.dealStatusLost')}
                            </span>
                          )}
                        </div>
                      </div>
