...
export default function PipelinesPage() {
  ...
  async function handleCreatePipeline() {
    ...
    if (error || !pipeline) {
      toast.error(t("pipelines.toast.createPipelineFailed"));
      setCreating(false);
      return;
    }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <GatedButton
            ...
            gateReason={t("pipelines.gateReason.createPipelines")}
          ...
          <GatedButton
            ...
            gateReason={t("pipelines.gateReason.createDeals")}
      ...
      {pipelines.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border py-20">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            {t("pipelines.emptyState.description")}
          </p>
          <GatedButton
            canAct={canEditSettings}
            gateReason={t("pipelines.gateReason.createPipelines")}
      ...
      <Dialog open={newPipelineOpen} onOpenChange={setNewPipelineOpen}>
        <DialogContent className="sm:max-w-sm bg-popover border-border">
          ...
          <div className="py-2">
            <Label className="text-muted-foreground">{t("pipelines.form.pipelineNameLabel")}</Label>
            <Input
              value={newPipelineName}
              onChange={(e) => setNewPipelineName(e.target.value)}
              placeholder={t("pipelines.form.pipelineNamePh")}
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              {t("pipelines.form.defaultStagesHint")}
            </p>
          </div>
